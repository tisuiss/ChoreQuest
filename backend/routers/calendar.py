...
async def get_weekly_calendar(
    ...
    # child_id -> that child's vacation dates this week; their still-pending
    # occurrences are hidden (the redistributed sibling slot is generated by
    # auto_generate_week_assignments above).
    ...
    for a in assignments:
        ...
        if a.status == AssignmentStatus.pending and a.date in kid_vacation_map.get(
            a.user_id, set()
        ):
            continue
